...
integer::i, j, itr
real::Arr_1(1000), Arr_2(1000), func1, func2, x, z, eps
...
itr = 0
z=1
x=(4*atan(1.0)) !!arctan(1) = (pi/4) and multiplying with 4 gives us pi
i=0
j=0

!! Iterative methods for calculatig the functions for value of pi!!
...
DO
	...
	func1 = (1 - cos(x+z))/((x+z)**2)
	func2 = (sin(x+z)**2)/((1+cos(x+z))*((x+z)**2))
